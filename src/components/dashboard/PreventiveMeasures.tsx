  ...
  return (
    <div className="panel">
      ...
      <div className="mb-3 p-2 border border-border/50 rounded-sm">
        ...
        <div className="text-xl font-bold tabular-nums text-card-foreground">{city.borewellLimit}m</div>
        {city.gwOverdraft > 100 && (
          <div className="status-critical text-sm font-semibold mt-1">
      ...
      <div className="space-y-1.5">
        {PREVENTIVE_MEASURES.map((m, i) => (
          <div key={i} className="flex items-start gap-2 text-sm">
            ...
            <span className="text-card-foreground/80 font-body">{m}</span>
          </div>
        ))}
      </div>
    </div>
